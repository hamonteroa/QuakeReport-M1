...
public final class QueryUtils {
    ...
    public static List<Earthquake> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            for (int i = 0; i < featuresArray.length(); i++) {
                ...
                String[] place = properties.getString("place").split(LOCATION_SEPARATOR);
                String distance = "Near of";
                String location = "";
                if (place.length == 2) {
                ...
                earthquakes.add(new Earthquake(properties.getDouble("mag"),
                        distance,
                        location,
                        //(new SimpleDateFormat("MMM DD, yyyy").format(new Date(properties.getLong("time"))))
    ...
    /**
     * Query the USGS dataset and return a {@link List} object to represent a single earthquake.
     */
